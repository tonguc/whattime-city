...
export default function MarylandTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Eastern Time (EST/EDT) · Baltimore · UTC−5 / UTC−4</p>
      <MarylandClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Maryland City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Maryland: America/New_York (EST/EDT, Eastern Time).</footer>
    </ContentPageWrapper>
  )
}
