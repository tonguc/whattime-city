...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Lebanon observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Lebanon observes Eastern European Summer Time (EEST, UTC+3) from the last Sunday in March to the last Sunday in October. Outside this period, Lebanon uses EET (UTC+2).' } },
