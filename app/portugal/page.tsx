...
export default function PortugalTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Western European Time (WET/WEST) · Lisbon · UTC+0 / UTC+1 · Azores 1h behind</p>
      <PortugalClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Portugal & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Portugal: Europe/Lisbon (WET UTC+0 / WEST UTC+1); Azores: Atlantic/Azores.</footer>
    </ContentPageWrapper>
  )
}
