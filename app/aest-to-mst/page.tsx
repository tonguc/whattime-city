...
export default function AESTtoMST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">AEST to MST Converter</h1>
      <p className="text-lg text-slate-600 mb-6">Australian Eastern Standard Time → Mountain Standard Time · AEST is <strong>17 hours ahead</strong> of MST</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">AEST vs MST — Sydney to Denver</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            ...
            <p><strong className="text-slate-700">MST (UTC-7)</strong> — Mountain Standard Time. Colorado, Utah, and surrounding states shift to MDT (UTC-6) in summer. Arizona stays on MST year-round.</p>
