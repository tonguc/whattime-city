...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'AEST to MST — Australian Eastern to Mountain', description: 'AEST is 17 hours ahead of MST. Live clocks and full conversion table.', type: 'website', url: 'https://whattime.city/aest-to-mst/', siteName: 'whattime.city' },
  twitter: { card: 'summary_large_image', title: 'AEST to MST — Australian Eastern to Mountain', description: 'AEST is 17 hours ahead of MST. Live converter.' },
}
