...
export default function IrelandClockClient() {
  const { time, date, mounted, isDST } = useClockState('Europe/Dublin')
  ...
  return (
    <div className="space-y-4">
      <ClockHero
        ...
        clocks={[{ label: 'Current Time in Ireland', time }]}
        date={date}
        mounted={mounted}
        badges={[
          { label: isDST ? 'IST · UTC+1' : 'GMT · UTC+0' },
          { label: 'Europe&apos;s Tech Capital' },
          { label: 'Dublin' },
        ]}
      />
