...
export default function SwedenTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Central European Time (CET) · UTC+1 in winter · CEST (UTC+2) during Daylight Saving Time</p>
      <SwedenClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Sweden City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Sweden: Europe/Stockholm (CET UTC+1 / CEST UTC+2).</footer>
    </ContentPageWrapper>
  )
}
