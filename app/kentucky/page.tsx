...
export default function KentuckyTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Eastern Time (EST/EDT) · Louisville · Some Western Counties on Central Time</p>
      <KentuckyClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Kentucky City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Kentucky: America/Kentucky/Louisville (EST/EDT) for most; America/Chicago (CST/CDT) for western counties.</footer>
    </ContentPageWrapper>
  )
}
