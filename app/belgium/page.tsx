...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Belgium observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Belgium observes Central European Summer Time (CEST, UTC+2) from the last Sunday in March to the last Sunday in October. Outside this period, Belgium uses CET (UTC+1).' } },
