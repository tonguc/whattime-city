...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Time in North Macedonia Now — CET (UTC+1)', description: 'Live North Macedonia time. Skopje on CET (UTC+1).', type: 'website', url: 'https://whattime.city/north-macedonia/', siteName: 'whattime.city' },
}
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does North Macedonia observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. North Macedonia observes Central European Summer Time (CEST, UTC+2) from the last Sunday in March to the last Sunday in October. Outside this period, North Macedonia uses CET (UTC+1).' } },
