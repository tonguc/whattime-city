...
export default function NewMexicoTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Mountain Time (MST/MDT) · Albuquerque · UTC−7/−6</p>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. New Mexico: America/Denver (MST/MDT, Mountain Time).</footer>
    </ContentPageWrapper>
  )
}
