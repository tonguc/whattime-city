...
export default function BSTtoEST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">BST to EST Converter</h1>
      <p className="text-lg text-slate-600 mb-6">British Summer Time → Eastern Time · BST is <strong>5 hours ahead</strong> of EDT in summer</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">BST vs EST — London to New York in Summer</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p><strong className="text-slate-700">BST (British Summer Time)</strong> is UTC+1, active from the last Sunday of March to the last Sunday of October. Outside this window, the UK uses GMT (UTC+0).</p>
            <p><strong className="text-slate-700">EST (Eastern Standard Time)</strong> is UTC-5, used by New York in winter. In summer the US East Coast uses <strong>EDT (UTC-4)</strong>.</p>
