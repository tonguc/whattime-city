  ...
  return (
    <ContentPageWrapper>
      ...
      <section className="mt-4 mb-4">
        <div className={card}>
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">CET Quick Reference — When it is noon in Amsterdam</h2>
      ...
      <section className="mb-4">
        <div className={card}>
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Netherlands City Times & Converters</h2>
