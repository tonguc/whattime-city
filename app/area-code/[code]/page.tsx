...
const areaCodes: Record<string, AreaCodeData> = {
  ...
  '213': {
    ...
    utcOffsetDST: 'UTC-7',
    observesDST: true,
    coverageArea: 'Downtown Los Angeles, Hollywood, Echo Park, Silver Lake, Koreatown, Boyle Heights',
    majorCities: ['Downtown LA', 'Hollywood', 'Echo Park', 'Silver Lake', 'Koreatown'],
    introduced: '1947',
    notes: 'One of the original 1947 area codes. Covers the historic core of Los Angeles. Overlaid by 323 in 1998 for surrounding neighborhoods. 213 remains the prestige downtown LA code.',
