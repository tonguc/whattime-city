...
export default function PolandTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central European Time (CET/CEST) · Warsaw · UTC+1 / UTC+2</p>
      <PolandClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Poland & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Poland: Europe/Warsaw (CET UTC+1 / CEST UTC+2).</footer>
    </ContentPageWrapper>
  )
}
