...
export default function IndianaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Eastern Time (EST/EDT) · Indianapolis · NW Indiana on Central Time</p>
      <IndianaClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Indiana City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Indiana: America/Indiana/Indianapolis (EST/EDT) for most; America/Indiana/Knox (CST/CDT) for northwest counties.</footer>
    </ContentPageWrapper>
  )
}
