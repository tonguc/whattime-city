...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Slovakia observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Slovakia observes Central European Summer Time (CEST, UTC+2) from the last Sunday in March to the last Sunday in October. Outside this period, Slovakia uses CET (UTC+1).' } },
