...
export default function TennesseeTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central Time (CST/CDT) · Nashville · East TN uses Eastern Time</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Tennessee City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Tennessee: America/Chicago (CST/CDT) for most of state; America/New_York (EST/EDT) for eastern counties.</footer>
    </ContentPageWrapper>
  )
}
