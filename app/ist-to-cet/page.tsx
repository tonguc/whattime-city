...
export default function ISTtoCET() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800 dark:text-white">IST to CET Converter</h1>
      <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">India Standard Time → Central European Time · IST is <strong>4 hours 30 minutes ahead</strong> of CET</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">IST vs CET — India to Europe</h2>
          <div className="space-y-3 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            <p><strong className="text-slate-700 dark:text-slate-200">IST (UTC+5:30)</strong> — India Standard Time, fixed year-round with no DST. One national time zone for the entire country.</p>
            <p><strong className="text-slate-700 dark:text-slate-200">CET (UTC+1)</strong> — Central European Time. Shifts to CEST (UTC+2) in summer (late March–late October).</p>
