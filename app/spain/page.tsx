...
export default function SpainTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Central European Time (CET) · UTC+1 in winter · CEST (UTC+2) in summer · Canary Islands 1h behind</p>
      <SpainClockClient />
      <CountryFactsSection hubSlug="spain" />
      <section className="mt-4 mb-4">
        <div className={card}>
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Spain Time Zones</h2>
      ...
      <section className="mb-4">
        <div className={card}>
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Spain City Times & Converters</h2>
