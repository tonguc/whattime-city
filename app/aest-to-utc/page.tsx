...
export default function AESTtoUTC() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">AEST to UTC Converter</h1>
      <p className="text-lg text-slate-600 mb-6">Australian Eastern Standard Time → Coordinated Universal Time · AEST is <strong>10 hours ahead</strong> of UTC</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">AEST vs UTC — Sydney to World Standard Time</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p><strong className="text-slate-700">AEST (UTC+10)</strong> — Australian Eastern Standard Time. Used by NSW, VIC, QLD, ACT, and TAS. NSW/VIC/ACT/TAS shift to AEDT (UTC+11) in summer; Queensland stays on AEST year-round.</p>
            <p><strong className="text-slate-700">UTC (UTC+0)</strong> — The world's primary time standard. All global time zones are defined relative to UTC.</p>
