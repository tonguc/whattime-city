    ...
    <ContentPageWrapper>
      ...
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">EST vs CST — What You Need to Know</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p><strong className="text-slate-700">Eastern Standard Time (EST)</strong> is UTC-5, covering the US East Coast: New York, Florida, Georgia, and the Atlantic seaboard. During summer it becomes <strong>EDT (UTC-4)</strong>.</p>
            <p><strong className="text-slate-700">Central Standard Time (CST)</strong> is UTC-6, covering Illinois, Texas, Minnesota, and Louisiana. During summer it becomes <strong>CDT (UTC-5)</strong>.</p>
