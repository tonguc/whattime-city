...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Botswana observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'No. Botswana does not observe Daylight Saving Time. Botswana uses Central Africa Time (CAT, UTC+2) year-round.' } },
