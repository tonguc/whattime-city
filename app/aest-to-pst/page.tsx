...
export default function AESTtoPST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800 dark:text-white">AEST to PST Converter</h1>
      ...
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">AEST vs PST — Sydney to Los Angeles</h2>
          <div className="space-y-3 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            <p><strong className="text-slate-700 dark:text-slate-200">AEST (Australian Eastern Standard Time)</strong> is UTC+10. During Australian summer (October–April), NSW and Victoria use <strong>AEDT (UTC+11)</strong>.</p>
