...
export default function ArgentinaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Argentina Time (ART) · UTC−3 · No Daylight Saving Time since 2008</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Argentina City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Argentina: America/Argentina/Buenos_Aires (ART UTC−3, no DST since 2008).</footer>
    </ContentPageWrapper>
  )
}
