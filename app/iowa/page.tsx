...
export default function IowaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central Time (CST/CDT) · Des Moines · UTC−6 / UTC−5</p>
      <IowaClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Iowa City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Iowa: America/Chicago (CST/CDT, Central Time).</footer>
    </ContentPageWrapper>
  )
}
