...
export const metadata: Metadata = {
  title: 'Time in Czech Republic Now — CET (UTC+1) · Prague',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Czech Republic observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'Check the live clock above for current offset. Many countries observe Daylight Saving Time seasonally — verify the current Czech Republic offset in the time difference table.' } },
