...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Georgia observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'No. Georgia does not observe Daylight Saving Time. Georgia uses Georgia Standard Time (GET, UTC+4) year-round.' } },
