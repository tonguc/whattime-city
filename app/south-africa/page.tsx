...
export default function SouthAfricaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">South Africa Standard Time (SAST) · UTC+2 · No Daylight Saving Time</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">South Africa City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. South Africa: Africa/Johannesburg (SAST UTC+2, no DST).</footer>
    </ContentPageWrapper>
  )
}
