...
export default function JSTtoIST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">JST to IST Converter</h1>
      <p className="text-lg text-slate-600 mb-6">Japan Standard Time → India Standard Time · JST is <strong>3 hours 30 minutes ahead</strong> of IST</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">JST vs IST — Tokyo to Bangalore</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p><strong className="text-slate-700">JST (UTC+9)</strong> — Japan Standard Time. Fixed, no DST. <strong className="text-slate-700">IST (UTC+5:30)</strong> — India Standard Time. Fixed, no DST.</p>
