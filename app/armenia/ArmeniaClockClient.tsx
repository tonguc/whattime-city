...
export default function ArmeniaClockClient() {
  const { time, date, mounted } = useClockState('Asia/Yerevan')
  ...
  return (
    <div className="space-y-4">
      <ClockHero
        ...
        clocks={[{ label: 'Current Time in Armenia', time }]}
        date={date}
        mounted={mounted}
        badges={[
          { label: 'AMT · UTC+4 (always)', highlight: true },
          { label: 'No DST since 2012' },
          { label: 'Yerevan', highlight: true },
        ]}
      />
