...
export default function SenegalTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">GMT (UTC+0) · Dakar · No Daylight Saving Time</p>
      <SenegalClockClient />
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Senegal: Africa/Dakar (GMT, UTC+0, no DST).</footer>
    </ContentPageWrapper>
  )
}
