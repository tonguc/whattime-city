...
export default function MalaysiaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Malaysia Time (MYT) · UTC+8 · No Daylight Saving Time</p>
      <MalaysiaClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Malaysia City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Malaysia: Asia/Kuala_Lumpur (MYT UTC+8, no DST).</footer>
    </ContentPageWrapper>
  )
}
