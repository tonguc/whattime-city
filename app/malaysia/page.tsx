...
export default function MalaysiaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 dark:text-white mb-1">Current Time in Malaysia</h1>
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Malaysia Time (MYT) · UTC+8 · No Daylight Saving Time</p>
      <MalaysiaClockClient />
