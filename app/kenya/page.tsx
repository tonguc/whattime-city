  ...
  return (
    <ContentPageWrapper>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Kenya City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Kenya: Africa/Nairobi (EAT UTC+3, no DST).</footer>
    </ContentPageWrapper>
  )
}
