...
export default function GMTtoIST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">GMT to IST Converter</h1>
      <p className="text-lg text-slate-600 mb-6">Greenwich Mean Time → India Standard Time · GMT is <strong>5 hours 30 minutes behind</strong> IST</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">GMT vs IST — London to India</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            ...
            <p><strong className="text-slate-700">IST (UTC+5:30)</strong> — India Standard Time, fixed year-round. The :30 offset means IST conversions always produce :00 or :30 minutes.</p>
