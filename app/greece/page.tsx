...
export default function GreeceTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Eastern European Time (EET/EEST) · Athens · UTC+2 / UTC+3</p>
      <GreeceClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Greece & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Greece: Europe/Athens (EET UTC+2 / EEST UTC+3).</footer>
    </ContentPageWrapper>
  )
}
