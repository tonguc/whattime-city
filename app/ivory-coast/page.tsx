...
export default function IvoryCoastTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">GMT (UTC+0) · Abidjan · No Daylight Saving Time</p>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Ivory Coast: Africa/Abidjan (GMT, UTC+0, no DST).</footer>
    </ContentPageWrapper>
  )
}
