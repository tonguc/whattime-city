...
export default function ConnecticutTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Eastern Time (EST/EDT) · Hartford · UTC−5 / UTC−4</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Connecticut City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Connecticut: America/New_York (EST/EDT, Eastern Time).</footer>
    </ContentPageWrapper>
  )
}
