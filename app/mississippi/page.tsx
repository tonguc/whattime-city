...
export default function MississippiTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Central Time (CST/CDT) · Jackson · UTC−6 / UTC−5</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Mississippi City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Mississippi: America/Chicago (CST/CDT, Central Time).</footer>
    </ContentPageWrapper>
  )
}
