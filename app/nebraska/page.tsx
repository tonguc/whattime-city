...
export default function NebraskaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central Time (CST/CDT) · Omaha · Lincoln · UTC−6/−5</p>
      <NebraskaClockClient />
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Nebraska: America/Chicago (CST/CDT) for most; America/Denver (MST/MDT) for panhandle counties.</footer>
    </ContentPageWrapper>
  )
}
