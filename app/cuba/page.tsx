...
export default function CubaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Cuba Standard Time (CST/CDT) · Havana · UTC−5 / UTC−4</p>
      <CubaClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Cuba & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Cuba: America/Havana (CST UTC−5 / CDT UTC−4).</footer>
    </ContentPageWrapper>
  )
}
