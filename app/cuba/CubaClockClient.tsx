...
export default function CubaClockClient() {
  const { time, date, mounted, isDST } = useClockState('America/Havana')
  ...
  return (
    <div className="space-y-4">
      <ClockHero
        bgColor="bg-blue-700"
        clocks={[{ label: 'Current Time in Cuba', time }]}
        date={date}
        mounted={mounted}
        badges={[
          { label: isDST ? 'CDT · UTC-4' : 'CST · UTC-5' },
          { label: 'Caribbean&apos;s Largest Island' },
          { label: 'Havana' },
        ]}
      />
