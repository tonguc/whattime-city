...
export default function IranTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Iran Standard Time (IRST/IRDT) · UTC+3:30 / UTC+4:30 · Half-hour offset</p>
      <IranClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Iran & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Iran: Asia/Tehran (IRST UTC+3:30 / IRDT UTC+4:30).</footer>
    </ContentPageWrapper>
  )
}
