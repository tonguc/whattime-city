...
export default function MyanmarTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Myanmar Time (MMT) · UTC+6:30 · Half-hour offset · No DST</p>
      <MyanmarClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Myanmar & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Myanmar: Asia/Rangoon (MMT UTC+6:30, no DST).</footer>
    </ContentPageWrapper>
  )
}
