...
export default function UkraineTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Eastern European Time (EET/EEST) · Kyiv · UTC+2 / UTC+3</p>
      <UkraineClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Ukraine & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Ukraine: Europe/Kyiv (EET UTC+2 / EEST UTC+3).</footer>
    </ContentPageWrapper>
  )
}
