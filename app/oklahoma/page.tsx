...
export default function OklahomaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 dark:text-white mb-1">Current Time in Oklahoma</h1>
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Central Time (CST/CDT) · Oklahoma City · UTC−6 / UTC−5</p>
      <OklahomaClockClient />
