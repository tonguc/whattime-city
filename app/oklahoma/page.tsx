...
export default function OklahomaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central Time (CST/CDT) · Oklahoma City · UTC−6 / UTC−5</p>
      <OklahomaClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Oklahoma City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Oklahoma: America/Chicago (CST/CDT, Central Time).</footer>
    </ContentPageWrapper>
  )
}
