...
export default function ColoradoTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Mountain Time (MT) · MST (UTC−7) in winter · MDT (UTC−6) during Daylight Saving Time</p>
      <ColoradoClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Colorado City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Colorado: America/Denver (MST UTC−7 / MDT UTC−6).</footer>
    </ContentPageWrapper>
  )
}
