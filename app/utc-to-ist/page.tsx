...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'UTC to IST — Universal to India Standard', description: 'UTC is 5:30 behind IST. Live clocks and full conversion table.', type: 'website', url: 'https://whattime.city/utc-to-ist/', siteName: 'whattime.city' },
