...
export default function UTCtoIST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800 dark:text-white">UTC to IST Converter</h1>
      <p className="text-lg text-slate-600 dark:text-slate-300 mb-6">Coordinated Universal Time → India Standard Time · UTC is <strong>5 hours 30 minutes behind</strong> IST</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
          <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">UTC vs IST — Converting to India Time</h2>
          <div className="space-y-3 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
            <p><strong className="text-slate-700 dark:text-slate-200">UTC (UTC+0)</strong> — Coordinated Universal Time, the world's primary time standard. Used in aviation, software, finance, and international communications.</p>
            <p><strong className="text-slate-700 dark:text-slate-200">IST (UTC+5:30)</strong> — India Standard Time, a fixed half-hour offset. No DST. The entire country of India — from Mumbai to Kolkata — uses the same single time zone.</p>
