...
export default function CameroonTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">West Africa Time (WAT) · UTC+1 · No Daylight Saving Time</p>
      <CameroonClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Cameroon & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Cameroon: Africa/Douala (WAT UTC+1, no DST).</footer>
    </ContentPageWrapper>
  )
}
