...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Gambia observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'No. The Gambia does not observe Daylight Saving Time. The Gambia uses Greenwich Mean Time (GMT, UTC+0) year-round.' } },
