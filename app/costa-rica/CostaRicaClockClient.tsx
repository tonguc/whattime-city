...
export default function CostaRicaClockClient() {
  const { time, date, mounted } = useClockState('America/Costa_Rica')
  ...
  return (
    <div className="space-y-4">
      <ClockHero
        bgColor="bg-blue-700"
        clocks={[{ label: 'Current Time in Costa Rica', time }]}
        date={date}
        mounted={mounted}
        badges={[
          { label: 'CST · UTC-6 (always)', highlight: true },
          { label: 'No DST — &ldquo;Pura Vida&rdquo;' },
          { label: 'San Jos&eacute;' },
        ]}
      />
