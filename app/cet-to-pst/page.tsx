...
export default function CETtoPST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">CET to PST Converter</h1>
      ...
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">CET vs PST — Europe to West Coast</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p><strong className="text-slate-700">CET (Central European Time)</strong> is UTC+1. In summer, Central Europe uses <strong>CEST (UTC+2)</strong> from the last Sunday of March to the last Sunday of October.</p>
