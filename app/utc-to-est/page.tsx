    ...
    <ContentPageWrapper>
      ...
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">UTC vs EST — What You Need to Know</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p>
              <strong className="text-slate-700">UTC (Coordinated Universal Time)</strong> is the world&apos;s primary time standard,
              used in aviation, software systems, and international communications. It does not observe Daylight Saving Time.
            </p>
            <p>
              <strong className="text-slate-700">Eastern Standard Time (EST)</strong> is UTC-5, used by the US East Coast in winter.
      ...
      <section className="mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">Quick UTC to EST Reference</h2>
