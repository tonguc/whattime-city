...
export default function NorthDakotaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central Time (CST/CDT) · Fargo · Bismarck · UTC−6/−5</p>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. North Dakota: America/Chicago (CST/CDT) for most; America/Denver (MST/MDT) for Bowman and Slope counties.</footer>
    </ContentPageWrapper>
  )
}
