...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'MST to CST — Mountain to Central Time', description: 'MST is 1 hour behind CST. Live clocks and full conversion table.', type: 'website', url: 'https://whattime.city/mst-to-cst/', siteName: 'whattime.city' },
