...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Togo observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'No. Togo does not observe Daylight Saving Time. Togo uses Greenwich Mean Time (GMT, UTC+0) year-round.' } },
