...
export default function BSTtoPST() {
  return (
    <ContentPageWrapper>
      ...
      <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-slate-800">BST to PST Converter</h1>
      <p className="text-lg text-slate-600 mb-6">British Summer Time → Pacific Standard Time · BST is <strong>8 hours ahead</strong> of PDT in summer</p>
      <TZPairClient config={config} />
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">BST vs PST — London to West Coast</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p><strong className="text-slate-700">BST</strong> is UTC+1, the UK&apos;s summer time (late March–late October). <strong className="text-slate-700">PST</strong> is UTC-8, US West Coast winter time. In summer both shift: BST (UTC+1) vs PDT (UTC-7) = 8 hours apart.</p>
