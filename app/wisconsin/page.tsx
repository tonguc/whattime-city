...
export default function WisconsinTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Central Time (CST/CDT) · Milwaukee · UTC−6 / UTC−5</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Wisconsin City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Wisconsin: America/Chicago (CST/CDT, Central Time).</footer>
    </ContentPageWrapper>
  )
}
