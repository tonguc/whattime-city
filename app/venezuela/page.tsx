...
export default function VenezuelaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Venezuela Time (VET) · UTC−4 · No Daylight Saving Time</p>
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 dark:text-white mb-4">Venezuela & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 dark:text-slate-500 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Venezuela: America/Caracas (VET UTC−4, no DST).</footer>
    </ContentPageWrapper>
  )
}
