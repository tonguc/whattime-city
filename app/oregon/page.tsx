...
export default function OregonTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Pacific Time (PST/PDT) · Portland · Malheur County on Mountain Time</p>
      <OregonClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Oregon City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Oregon: America/Los_Angeles (PST/PDT) for most of state; America/Boise (MST/MDT) for Malheur County.</footer>
    </ContentPageWrapper>
  )
}
