...
const PAIR_CONTEXTS: Record<string, string> = {
  ...
  'lagos-amsterdam': 'Lagos (WAT, UTC+1) and Amsterdam (CET/CEST, UTC+1/+2) share the same UTC offset in winter — no time difference. During Central European Summer Time (CEST, April–October), Amsterdam moves to UTC+2, making Amsterdam 1 hour ahead of Lagos. Nigeria does not observe DST. The Lagos–Amsterdam corridor is significant for Dutch–Nigerian trade and Schiphol Airport connections.',
  'amsterdam-lagos': 'Amsterdam (CET/CEST, UTC+1/+2) is on the same time as Lagos (WAT, UTC+1) in winter, and 1 hour ahead during Central European Summer Time (CEST). The Netherlands is a major trade and logistics partner for Nigeria through the Port of Rotterdam and Schiphol Airport. During Dutch winter (CET), both cities are at UTC+1 — perfect alignment for calls.',
  'sao-paulo-san-francisco': 'São Paulo (BRT, UTC−3) is 5 hours ahead of San Francisco (PST, UTC−8) in winter. During US summer (PDT, UTC−7), São Paulo is 4 hours ahead. Brazil abolished DST in 2019 and stays on BRT (UTC−3) year-round. The São Paulo–San Francisco tech and startup corridor has grown significantly, with many Brazilian tech companies expanding to Silicon Valley.',
  'san-francisco-sao-paulo': 'San Francisco (PST/PDT, UTC−8/−7) is 4–5 hours behind São Paulo (BRT, UTC−3). In winter (PST), SF is 5 hours behind; during US summer (PDT), it is 4 hours behind. Brazil abandoned DST in 2019 and stays on UTC−3 permanently. São Paulo is Latin America\'s largest tech and financial hub; this corridor supports fintech, e-commerce, and startup investment flows.',
