...
export default function UtahTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Mountain Time (MST/MDT) · Salt Lake City · UTC−7 / UTC−6</p>
      <UtahClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Utah City Times & Converters</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Utah: America/Denver (MST/MDT, Mountain Time).</footer>
    </ContentPageWrapper>
  )
}
