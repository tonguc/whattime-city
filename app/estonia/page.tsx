...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Does Estonia observe Daylight Saving Time?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Estonia observes Eastern European Summer Time (EEST, UTC+3) from the last Sunday in March to the last Sunday in October. Outside this period, Estonia uses EET (UTC+2).' } },
