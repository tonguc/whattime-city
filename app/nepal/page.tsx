...
export default function NepalTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Nepal Time (NPT) · UTC+5:45 · 45-minute offset · No DST</p>
      <NepalClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Nepal & Nearby Times</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Nepal: Asia/Kathmandu (NPT UTC+5:45, no DST).</footer>
    </ContentPageWrapper>
  )
}
