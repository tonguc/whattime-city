...
export default function WestVirginiaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Eastern Time (EST/EDT) · Charleston · UTC−5/−4</p>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. West Virginia: America/New_York (EST/EDT, Eastern Time).</footer>
    </ContentPageWrapper>
  )
}
