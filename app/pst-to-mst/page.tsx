    ...
    <ContentPageWrapper>
      ...
      <section className="mt-4 mb-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="text-xl font-semibold text-slate-800 mb-4">PST vs MST — What You Need to Know</h2>
          <div className="space-y-3 text-slate-600 text-sm leading-relaxed">
            <p>
              <strong className="text-slate-700">PST (Pacific Standard Time)</strong> is UTC-8, covering
              California, Washington, Oregon, and Nevada. During DST it becomes <strong>PDT (UTC-7)</strong>.
            </p>
            <p>
              <strong className="text-slate-700">MST (Mountain Standard Time)</strong> is UTC-7, covering
