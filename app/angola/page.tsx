...
export default function AngolaTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">WAT (UTC+1) · Luanda · No Daylight Saving Time</p>
      <AngolaClockClient />
      ...
      <section className="mb-4"><div className={card}>
        <h2 className="text-xl font-semibold text-slate-800 mb-4">Africa & Related Time Pages</h2>
      ...
      <footer className="text-xs text-slate-400 text-center mt-2 mb-4">Time zone data powered by the IANA Time Zone Database. Angola: Africa/Luanda (WAT, UTC+1, no DST).</footer>
    </ContentPageWrapper>
  )
}
