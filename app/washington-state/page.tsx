...
export default function WashingtonStateTimePage() {
  return (
    <ContentPageWrapper>
      ...
      <p className="text-sm text-slate-500 mb-6">Pacific Time (PT) · PST (UTC−8) in winter · PDT (UTC−7) during Daylight Saving Time</p>
      <WashingtonStateClockClient />
      <section className="mt-4 mb-4">
        <div className={card}>
          <h2 className="text-xl font-semibold text-slate-800 mb-4">PST Quick Reference — When it is noon in Seattle</h2>
      ...
      <section className="mb-4">
        <div className={card}>
          <h2 className="text-xl font-semibold text-slate-800 mb-4">Washington State City Times & Converters</h2>
