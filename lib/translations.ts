...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    compareTimeDesc: 'Compare current time between any two cities. See live clocks, time difference, and best times to call.',
  ...
  tr: {
    ...
    openTool: 'Aracı Aç',
    compareTime: 'Saat Karşılaştır',
    compareTimeDesc: 'İki şehir arasındaki anlık saati karşılaştırın. Canlı saatler, zaman farkı ve arama için en iyi zamanları görün.',
  ...
  de: {
    ...
    compareTime: 'Zeit Vergleichen',
    compareTimeDesc: 'Vergleichen Sie die aktuelle Zeit zwischen zwei Städten.',
  ...
  fr: {
    ...
    compareTime: 'Comparer le Temps',
    compareTimeDesc: 'Comparez l\'heure actuelle entre deux villes.',
  ...
  es: {
    ...
    compareTime: 'Comparar Hora',
    compareTimeDesc: 'Compare la hora actual entre dos ciudades.',
  ...
  pt: {
    ...
    compareTime: 'Comparar Hora',
    compareTimeDesc: 'Compare a hora atual entre duas cidades.',
  ...
  ru: {
    ...
    openTool: 'Открыть',
    compareTime: 'Сравнить время',
    compareTimeDesc: 'Сравните текущее время между двумя городами.',
  ...
  ar: {
    ...
    openTool: 'فتح الأداة',
    compareTime: 'مقارنة الوقت',
    compareTimeDesc: 'قارن الوقت الحالي بين مدينتين.',
  ...
  ja: {
    ...
    openTool: 'ツールを開く',
    compareTime: '時間を比較',
    compareTimeDesc: '2つの都市間の現在時刻を比較します。',
    timeConverter: '時間変換',
  ...
  ko: {
    ...
    openTool: '도구 열기',
    compareTime: '시간 비교',
    compareTimeDesc: '두 도시 간의 현재 시간을 비교합니다.',
  ...
  it: {
    ...
    compareTime: 'Confronta Ora',
    compareTimeDesc: 'Confronta l\'ora corrente tra due città.',
  ...
  nl: {
    ...
    openTool: 'Open Tool',
    compareTime: 'Tijd Vergelijken',
    compareTimeDesc: 'Vergelijk de huidige tijd tussen twee steden.',
