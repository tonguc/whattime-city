    ...
    <header className={`sticky top-0 z-[9999] w-full backdrop-blur-2xl border-b transition-colors duration-300 shadow-sm ${
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-2 flex items-center justify-between gap-2 sm:gap-3">
        ...
        <nav className="flex items-center gap-0.5 sm:gap-1">
          {/* Mobile: Cities, Countries, Guides + Settings icon */}
          ...
          {/* Desktop-only links */}
          <Link href="/tools" className={`hidden md:block px-2.5 py-2 rounded-lg text-sm font-medium transition-all ${isLight ? 'hover:bg-slate-100 text-slate-600' : 'hover:bg-slate-800 text-slate-300'}`}>
            Tools
          </Link>
