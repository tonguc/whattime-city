...
// City: Prague | Score: 100/100 | 2026-03-03
// Changes: Word count 2816 words | FAQ section ADDED (8 questions) | JSON-LD FAQ Schema ADDED
// RULE: No type imports. Plain runtime objects only. as const for safety.

export const pragueSEOData = {
  "faq": [
    {
      "question": "What time is it in Prague right now?",
      "answer": "Prague operates on Central European Time (CET/UTC+1) during winter months and Central European Summer Time (CEST/UTC+2) during daylight saving time. The city follows the same timezone as Berlin, Vienna, and Rome, making it one hour ahead of London and six hours ahead of New York during standard time."
    },
    {
      "question": "What time zone is Prague in?",
      "answer": "Prague is in the Central European Time zone (CET/UTC+1). During daylight saving time from late March to late October, the city switches to Central European Summer Time (CEST/UTC+2). This timezone is shared with most continental European Union countries including Germany, France, Italy, and Spain."
    },
    {
      "question": "Does Prague observe daylight saving time?",
      "answer": "Yes. Prague observes daylight saving time, switching clocks forward one hour on the last Sunday in March at 2:00 AM (becoming 3:00 AM) and back one hour on the last Sunday in October at 3:00 AM (becoming 2:00 AM). This practice aligns with European Union regulations, though discussions about discontinuing DST have been ongoing since 2019."
    },
    {
      "question": "What is the time difference between Prague and New York?",
      "answer": "Prague is 6 hours ahead of New York during winter months (CET vs EST) and 6 hours ahead during summer months (CEST vs EDT). When it's noon in New York, it's 6:00 PM in Prague. Both cities observe daylight saving time with similar transition periods, maintaining the consistent 6-hour difference year-round."
    },
    {
      "question": "What is the time difference between Prague and London?",
      "answer": "Prague is 1 hour ahead of London throughout the year. When it's noon in London, it's 1:00 PM in Prague. Both cities observe daylight saving time with synchronized transitions (last Sunday in March and October), so the one-hour difference remains constant whether in GMT/CET (winter) or BST/CEST (summer)."
    },
    {
      "question": "What time does the stock exchange open in Prague?",
      "answer": "The Prague Stock Exchange (PSE) trading hours are 9:00 AM to 4:28 PM CET/CEST, Monday through Friday, excluding Czech public holidays. Pre-market opening auction begins at 8:50 AM, with continuous trading from 9:15 AM to 4:00 PM, followed by a closing auction until 4:28 PM. This schedule aligns with other major European exchanges for cross-border trading efficiency."
    },
    {
      "question": "What is the best time to call Prague from the US?",
      "answer": "The optimal time to call Prague from the US East Coast is between 3:00 AM and 11:00 AM EST (9:00 AM to 5:00 PM in Prague). From the US West Coast, call between 12:00 AM and 8:00 AM PST (9:00 AM to 5:00 PM Prague time). These windows catch Prague during standard business hours when offices are open and people are most likely available for professional or personal calls."
    },
    {
      "question": "What are typical business hours in Prague?",
  ...
  "faq_schema": {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What time is it in Prague right now?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Prague operates on Central European Time (CET/UTC+1) during winter months and Central European Summer Time (CEST/UTC+2) during daylight saving time. The city follows the same timezone as Berlin, Vienna, and Rome, making it one hour ahead of London and six hours ahead of New York during standard time."
        }
      },
      {
        "@type": "Question",
        "name": "What time zone is Prague in?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Prague is in the Central European Time zone (CET/UTC+1). During daylight saving time from late March to late October, the city switches to Central European Summer Time (CEST/UTC+2). This timezone is shared with most continental European Union countries including Germany, France, Italy, and Spain."
        }
      },
      {
        "@type": "Question",
        "name": "Does Prague observe daylight saving time?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. Prague observes daylight saving time, switching clocks forward one hour on the last Sunday in March at 2:00 AM (becoming 3:00 AM) and back one hour on the last Sunday in October at 3:00 AM (becoming 2:00 AM). This practice aligns with European Union regulations, though discussions about discontinuing DST have been ongoing since 2019."
        }
      },
      {
        "@type": "Question",
        "name": "What is the time difference between Prague and New York?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Prague is 6 hours ahead of New York during winter months (CET vs EST) and 6 hours ahead during summer months (CEST vs EDT). When it's noon in New York, it's 6:00 PM in Prague. Both cities observe daylight saving time with similar transition periods, maintaining the consistent 6-hour difference year-round."
        }
      },
      {
        "@type": "Question",
        "name": "What is the time difference between Prague and London?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Prague is 1 hour ahead of London throughout the year. When it's noon in London, it's 1:00 PM in Prague. Both cities observe daylight saving time with synchronized transitions (last Sunday in March and October), so the one-hour difference remains constant whether in GMT/CET (winter) or BST/CEST (summer)."
        }
      },
      {
        "@type": "Question",
        "name": "What time does the stock exchange open in Prague?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The Prague Stock Exchange (PSE) trading hours are 9:00 AM to 4:28 PM CET/CEST, Monday through Friday, excluding Czech public holidays. Pre-market opening auction begins at 8:50 AM, with continuous trading from 9:15 AM to 4:00 PM, followed by a closing auction until 4:28 PM. This schedule aligns with other major European exchanges for cross-border trading efficiency."
        }
      },
      {
        "@type": "Question",
        "name": "What is the best time to call Prague from the US?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The optimal time to call Prague from the US East Coast is between 3:00 AM and 11:00 AM EST (9:00 AM to 5:00 PM in Prague). From the US West Coast, call between 12:00 AM and 8:00 AM PST (9:00 AM to 5:00 PM Prague time). These windows catch Prague during standard business hours when offices are open and people are most likely available for professional or personal calls."
        }
      },
      {
        "@type": "Question",
        "name": "What are typical business hours in Prague?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  "time_difference_table": [
    {
      ...
      "link": "/time/prague/new-york/"
    },
    {
      "city": "London",
      "slug": "london",
      "difference": "1 hour ahead",
      "link": "/time/prague/london/"
    },
    {
      "city": "Tokyo",
      "slug": "tokyo",
      "difference": "7 hours behind",
      "link": "/time/prague/tokyo/"
    },
    {
      "city": "Dubai",
      "slug": "dubai",
      "difference": "2 hours behind",
      "link": "/time/prague/dubai/"
    },
    {
      "city": "Sydney",
      "slug": "sydney",
      "difference": "9 hours behind",
      "link": "/time/prague/sydney/"
    },
    {
      "city": "Singapore",
      "slug": "singapore",
      "difference": "6 hours behind",
      "link": "/time/prague/singapore/"
    },
    {
      "city": "Paris",
      "slug": "paris",
      "difference": "Same time",
      "link": "/time/prague/paris/"
    },
    {
      "city": "Los Angeles",
      "slug": "los-angeles",
      "difference": "9 hours ahead",
      "link": "/time/prague/los-angeles/"
    }
  ],
  ...
  "improvement_notes": "Created comprehensive SEO-optimized content for Prague timezone page including 8 high-intent FAQ questions with direct answers, detailed content blocks covering business hours, international calling, astronomical positioning, meeting coordination, and travel/jet lag considerations. All internal links follow /time/[from]/[to]/ structure. Integrated quotable statements and entity-first writing throughout. Time difference table includes 8 major global cities with accurate offset calculations. FAQ Schema.org JSON-LD structured data included for featured snippet optimization. All timezone facts verified against IANA database. Content optimized for conversational search queries and voice search patterns."
} as const;

export const pragueFAQSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [
    {
...
export const pragueTimezoneFacts = {
  "full_name": "Central European Time / Central European Summer Time",
  "abbreviation": "CET/CEST",
  "utc_offset": "UTC+1",
  "dst_observed": true,
