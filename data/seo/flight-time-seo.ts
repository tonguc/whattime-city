export const flightTimeSEO = {
  ...
  content: {
    ...
    whoIsItFor: "Frequent flyers, travel planners, and anyone booking international flights will find this tool useful. It eliminates confusion about what time you will actually arrive at your destination in local time, especially when crossing multiple time zones.",
    sections: [
      { title: "How It Works", content: "Enter your departure city, arrival city, departure time, and flight duration. The calculator accounts for time zone differences and DST automatically." },
    ...
    internalLinks: [
      { text: "Time Converter", href: "/time-converter", description: "Quick conversions" },
      { text: "Jet Lag Advisor", href: "/jet-lag-advisor", description: "Recovery tips" },
      { text: "Meeting Planner", href: "/meeting", description: "Schedule across zones" }
    ],
    faq: [
