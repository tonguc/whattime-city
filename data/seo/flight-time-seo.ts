export const flightTimeSEO = {
  ...
  content: {
    ...
    popularRoutes: [
      ...
      { route: "New York (JFK) → Dubai (DXB)", duration: "~12h 30m", depart: "11:00 PM EST", arrive: "7:30 PM GST (+1 day)", note: "EST UTC-5 → GST UTC+4 = +9h" },
      { route: "New York (JFK) → Mumbai (BOM)", duration: "~14h", depart: "9:00 PM EST", arrive: "8:30 PM IST (+1 day)", note: "EST UTC-5 → IST UTC+5:30 = +10.5h" },
      { route: "New York (JFK) → Tokyo (HND)", duration: "~14h", depart: "1:00 PM EST", arrive: "4:00 PM JST (+1 day)", note: "EST UTC-5 → JST UTC+9 = +14h" },
      { route: "New York (JFK) → Frankfurt (FRA)", duration: "~7h 30m", depart: "9:00 PM EST", arrive: "11:30 AM CET (+1 day)", note: "EST UTC-5 → CET UTC+1 = +6h" },
      ...
      { route: "Los Angeles (LAX) → Sydney (SYD)", duration: "~15h", depart: "10:30 PM PST", arrive: "8:30 AM AEDT (+2 days)", note: "PST UTC-8 → AEDT UTC+11 = +19h" },
      { route: "Los Angeles (LAX) → Seoul (ICN)", duration: "~13h", depart: "11:00 PM PST", arrive: "5:00 AM KST (+2 days)", note: "PST UTC-8 → KST UTC+9 = +17h" },
      { route: "Los Angeles (LAX) → Mexico City (MEX)", duration: "~4h", depart: "9:00 AM PST", arrive: "3:00 PM CST", note: "PST UTC-8 → CST UTC-6 = +2h" },
      { route: "San Francisco (SFO) → London (LHR)", duration: "~10h 30m", depart: "5:00 PM PST", arrive: "11:30 AM GMT (+1 day)", note: "PST UTC-8 → GMT UTC+0 = +8h" },
      { route: "San Francisco (SFO) → Tokyo (NRT)", duration: "~11h", depart: "12:00 PM PST", arrive: "5:00 PM JST (+1 day)", note: "PST UTC-8 → JST UTC+9 = +17h" },
      { route: "Chicago (ORD) → London (LHR)", duration: "~9h", depart: "9:00 PM CST", arrive: "11:00 AM GMT (+1 day)", note: "CST UTC-6 → GMT UTC+0 = +6h" },
      { route: "Toronto (YYZ) → London (LHR)", duration: "~7h 30m", depart: "9:30 PM EST", arrive: "10:00 AM GMT (+1 day)", note: "EST UTC-5 → GMT UTC+0 = +5h" },
      ...
      { route: "London (LHR) → Sydney (SYD)", duration: "~22h (via Singapore)", depart: "9:30 PM GMT", arrive: "5:30 AM AEDT (+2 days)", note: "GMT UTC+0 → AEDT UTC+11 = +11h" },
      { route: "London (LHR) → Hong Kong (HKG)", duration: "~12h", depart: "1:00 PM GMT", arrive: "9:00 AM HKT (+1 day)", note: "GMT UTC+0 → HKT UTC+8 = +8h" },
      { route: "London (LHR) → Johannesburg (JNB)", duration: "~11h", depart: "8:00 PM GMT", arrive: "9:00 AM SAST (+1 day)", note: "GMT UTC+0 → SAST UTC+2 = +2h" },
      { route: "London (LHR) → Cape Town (CPT)", duration: "~11h 30m", depart: "8:30 PM GMT", arrive: "10:00 AM SAST (+1 day)", note: "GMT UTC+0 → SAST UTC+2 = +2h" },
      { route: "Paris (CDG) → New York (JFK)", duration: "~8h 30m", depart: "10:30 AM CET", arrive: "1:00 PM EST", note: "CET UTC+1 → EST UTC-5 = -6h" },
      { route: "Dubai (DXB) → London (LHR)", duration: "~7h", depart: "2:00 AM GST", arrive: "5:00 AM GMT", note: "GST UTC+4 → GMT UTC+0 = -4h" },
      { route: "Dubai (DXB) → New York (JFK)", duration: "~14h", depart: "2:00 AM GST", arrive: "8:00 AM EST", note: "GST UTC+4 → EST UTC-5 = -9h" },
      { route: "Dubai (DXB) → Singapore (SIN)", duration: "~7h 30m", depart: "3:00 AM GST", arrive: "2:30 PM SGT", note: "GST UTC+4 → SGT UTC+8 = +4h" },
      { route: "Singapore (SIN) → London (LHR)", duration: "~13h", depart: "11:00 PM SGT", arrive: "5:00 AM GMT (+1 day)", note: "SGT UTC+8 → GMT UTC+0 = -8h" },
      { route: "Singapore (SIN) → Sydney (SYD)", duration: "~8h", depart: "8:00 PM SGT", arrive: "7:00 AM AEDT (+1 day)", note: "SGT UTC+8 → AEDT UTC+11 = +3h" },
      ...
      { route: "Tokyo (HND) → Singapore (SIN)", duration: "~7h", depart: "10:00 AM JST", arrive: "4:00 PM SGT", note: "JST UTC+9 → SGT UTC+8 = -1h" },
      { route: "Mumbai (BOM) → London (LHR)", duration: "~9h", depart: "2:00 AM IST", arrive: "6:30 AM GMT", note: "IST UTC+5:30 → GMT UTC+0 = -5.5h" },
      { route: "Mumbai (BOM) → New York (JFK)", duration: "~16h", depart: "1:00 AM IST", arrive: "7:30 AM EST", note: "IST UTC+5:30 → EST UTC-5 = -10.5h" },
      ...
      { route: "Sydney (SYD) → Singapore (SIN)", duration: "~8h", depart: "11:00 AM AEST", arrive: "4:00 PM SGT", note: "AEST UTC+10 → SGT UTC+8 = -2h" },
    ]
  }
} as const;
